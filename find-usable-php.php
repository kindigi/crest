...
// all users that run through this code path will see Crest run more slowly
...
if (empty($modernPhps)) {
    throw new Exception('Sorry, but you do not have a version of PHP installed that is compatible with Crest (8+).');
}
