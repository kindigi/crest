...
use Crest\Configuration as RealConfiguration;
use Crest\Diagnose;
use Crest\DnsMasq;
use Crest\Expose;
...
class CliTest extends BaseApplicationTestCase
{
    ...
    public function test_tld_command_sets_tld()
    {
        ...
        $tester->assertCommandIsSuccessful();
        $this->assertStringContainsString('Your Crest TLD has been updated to [buzz]', $tester->getDisplay());
    }
    ...
    public function test_loopback_command_sets_loopback()
    {
        ...
        $tester->assertCommandIsSuccessful();
        $this->assertStringContainsString('Your Crest loopback address has been updated to [127.0.0.1]', $tester->getDisplay());
    }
    ...
    public function test_park_command()
    {
        ...
        $this->assertStringContainsString(
            "The [./tests/output] directory has been added to Crest's paths.",
            $tester->getDisplay()
        );
    ...
    public function test_unsecure_all_command()
    {
        ...
        $this->assertStringContainsString('All Crest sites will now serve traffic over HTTP.', $tester->getDisplay());
    }
    ...
    public function test_restart_command()
    {
        ...
        $this->assertStringContainsString('Crest services have been restarted.', $tester->getDisplay());
    }
    ...
    public function test_start_command()
    {
        ...
        $this->assertStringContainsString('Crest services have been started.', $tester->getDisplay());
    }
    ...
    public function test_stop_command()
    {
        ...
        $this->assertStringContainsString('Crest core services have been stopped.', $tester->getDisplay());
    }
    ...
    public function test_stop_command_handles_bad_services()
    {
        ...
        $this->assertStringContainsString('Invalid crest service', $tester->getDisplay());
    }
    ...
    public function test_force_uninstall_command()
    {
        ...
        $crest = Mockery::mock(Crest::class);
        $crest->shouldReceive('unlinkFromUsersBin')->once();
        $crest->shouldReceive('removeSudoersEntry')->once();
        $crest->shouldReceive('forceUninstallText')->once()->andReturn('uninstall-text');
    ...
    public function test_non_force_uninstall_command()
    {
        ...
        $this->assertStringContainsString('IF YOU WANT TO UNINSTALL CREST MANUALLY', $tester->getDisplay());
    }
    ...
    public function test_on_latest_version_command_succeeding()
    {
        ...
        $crest = Mockery::mock(Crest::class);
        $crest->shouldReceive('onLatestVersion')->once()->andReturn(true);
    ...
    public function test_on_latest_version_command_failing()
    {
        ...
        $crest = Mockery::mock(Crest::class);
        $crest->shouldReceive('onLatestVersion')->once()->andReturn(false);
    ...
    public function test_trust_command_on()
    {
        ...
        $crest = Mockery::mock(Crest::class);
        $crest->shouldReceive('createSudoersEntry')->once();
    ...
    public function test_use_command_without_specified_version_reads_phprc()
    {
        ...
        $this->assertStringContainsString(".crestphprc' specifying version: php@8.1", $tester->getDisplay());
    }
    ...
    public function test_use_command_with_no_specifications()
    {
        ...
        $this->assertStringContainsString('Crest is using php@8.2', $tester->getDisplay());
    }
