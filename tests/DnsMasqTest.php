...
class DnsMasqTest extends Yoast\PHPUnitPolyfills\TestCases\TestCase
{
    ...
    public function test_install_installs_and_places_configuration_files_in_proper_locations()
    {
        ...
        $this->assertSame('nameserver '.CREST_LOOPBACK.PHP_EOL, file_get_contents(__DIR__.'/output/resolver/test'));
        $this->assertSame('address=/.test/'.CREST_LOOPBACK.PHP_EOL.'listen-address='.CREST_LOOPBACK.PHP_EOL, file_get_contents(__DIR__.'/output/tld-test.conf'));
