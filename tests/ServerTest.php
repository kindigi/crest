...
class ServerTest extends Yoast\PHPUnitPolyfills\TestCases\TestCase
{
    ...
    {
        $this->assertEquals('onramp.test', Server::crestSiteFromIpAddressUri('onramp.test/auth/login', 'test'));
        $this->assertNull(Server::crestSiteFromIpAddressUri('onramp.dev/auth/login', 'test'));
    }
}
