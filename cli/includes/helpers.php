 ...
 * Define constants.
 */
if (! defined('CREST_HOME_PATH')) {
    if (testing()) {
        define('CREST_HOME_PATH', __DIR__.'/../../tests/config/crest');
    } else {
        define('CREST_HOME_PATH', $_SERVER['HOME'].'/.config/crest');
    }
}
if (! defined('CREST_STATIC_PREFIX')) {
    define('CREST_STATIC_PREFIX', '41c270e4-5535-4daa-b23e-c269744c2f45');
}

define('CREST_LOOPBACK', '127.0.0.1');
define('CREST_SERVER_PATH', realpath(__DIR__.'/../../server.php'));
